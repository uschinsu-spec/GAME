...
for(const dead of ['skill-runtime.js','world-runtime.js','styles.css','src/runtime-core.js']) assert.equal(fs.existsSync(dead),false,`${dead} phải được xóa sau khi xác nhận không còn load/reference`);
